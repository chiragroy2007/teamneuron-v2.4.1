    ...
    <footer className="bg-neutral-900 text-white py-12 border-t border-neutral-800 text-sm">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 opacity-90">
          ...
          {/* Navigation Links */}
          <nav className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-neutral-400 font-medium">
            ...
            <Link
              to="/whatsapp"
              className="bg-[#25D366] hover:bg-[#20BA5A] p-2 rounded-full transition-colors shadow-md"
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-neutral-400 text-[10px] mt-1 text-center md:text-right font-medium tracking-wide">TeamNeuron App v2.1.4</p>
          </div>
        </div>
      </div>
    </footer>
